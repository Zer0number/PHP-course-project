...
<div class="slider_area">
    ...
    <div class="about_area">
        <div class="icon_1 d-none d-md-block">
            <img src="<?=self::RES?>/img/icon/1.png" alt="">
        </div>
        <div class="icon_2 d-none d-md-block">
            <img src="<?=self::RES?>/img/icon/2.png" alt="">
        </div>
        <div class="icon_3 d-none d-md-block">
            <img src="<?=self::RES?>/img/icon/3.png" alt="">
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about_info_wrap">
                        ...
                        <ul class="food_list">
                            <li>
                                <img src="<?=self::RES?>/img/svg_icon/salad.svg" alt="">
                                <span>Fresh Ingredients</span>
                            </li>
                            <li>
                                <img src="<?=self::RES?>/img/svg_icon/tray.svg" alt="">
                ...
                <div class="col-lg-6">
                    <div class="about_img">
                        <div class="img_1">
                            <img src="<?=self::RES?>/img/about/big.png" alt="">
                        </div>
                        <div class="small_img">
                            <img src="<?=self::RES?>/img/about/small.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="col-xl-6 col-md-6 col-lg-6">
                    <div class="single_delicious d-flex align-items-center">
                        <div class="thumb">
                            <img src="<?=self::RES?>/img/delicious/1.png" alt="">
                        </div>
                        <div class="info">
                ...
                <div class="col-md-6 col-lg-6">
                        <div class="single_delicious d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=self::RES?>/img/delicious/3.png" alt="">
                                </div>
                                <div class="info">
                                    <h3>#10. Fried Rice</h3>
                                    <p>Craft beer elit seitan exercitation photo booth et 8-bit kale chips.</p>
                ...
                <div class="col-lg-6 col-md-6">
                        <div class="single_delicious d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=self::RES?>/img/delicious/5.png" alt="">
                                </div>
                                <div class="info">
                ...
                <div class="col-xl-6 col-md-6 col-lg-6">
                    <div class="single_delicious d-flex align-items-center">
                        <div class="thumb">
                            <img src="<?=self::RES?>/img/delicious/2.png" alt="">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-6 col-md-6">
                        <div class="single_delicious d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=self::RES?>/img/delicious/4.png" alt="">
                                </div>
                                <div class="info">
                ...
                <div class="col-lg-6 col-md-6">
                        <div class="single_delicious d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=self::RES?>/img/delicious/6.png" alt="">
                                </div>
                                <div class="info">
                    ...
                    <div class="testmonial_active owl-carousel">
                        <div class="single_carousel">
                            <div class="single_testmonial ">
                                ...
                                <div class="testmonial_author">
                                    <div class="thumb">
                                        <img src="<?=self::RES?>/img/testimonial/author.png" alt="">
                                    </div>
                                    <div class="name">
                        ...
                        <div class="single_carousel">
                            <div class="single_testmonial ">
                                ...
                                <div class="testmonial_author">
                                    <div class="thumb">
                                        <img src="<?=self::RES?>/img/testimonial/author2.png" alt="">
                                    </div>
                                    <div class="name">
    ...
    <div class="gallery_area">
        ...
        <div class="single_gallery big_img">
            <a class="popup-image" href="<?=self::RES?>/img/gallery/1.png"></a>
            <img src="<?=self::RES?>/img/gallery/1.png" alt="">
        </div>
        <div class="single_gallery small_img">
            <a class="popup-image" href="<?=self::RES?>/img/gallery/2.png"></a>
            <img src="<?=self::RES?>/img/gallery/2.png" alt="">
        </div>
        <div class="single_gallery small_img">
            <a class="popup-image" href="<?=self::RES?>/img/gallery/3.png"></a>
            <img src="<?=self::RES?>/img/gallery/3.png" alt="">
        </div>

        <div class="single_gallery small_img">
            <a class="popup-image" href="<?=self::RES?>/img/gallery/4.png"></a>
            <img src="<?=self::RES?>/img/gallery/4.png" alt="">
        </div>
        <div class="single_gallery small_img">
            <a class="popup-image" href="<?=self::RES?>/img/gallery/5.png"></a>
            <img src="<?=self::RES?>/img/gallery/5.png" alt="">
        </div>
        <div class="single_gallery big_img">
            <a class="popup-image" href="<?=self::RES?>/img/gallery/6.png"></a>
            <img src="<?=self::RES?>/img/gallery/6.png" alt="">
        </div>
    </div>
    ...
    <div class="Reservation_area">
        <div class="rev_icon_1 d-none d-md-block">
            <img src="<?=self::RES?>/img/icon/4.png" alt="">
        </div>
        <div class="rev_icon_2 d-none d-md-block">
            <img src="<?=self::RES?>/img/icon/5.png" alt="">
        </div>
        <div class="rev_icon_3 d-none d-md-block">
            <img src="<?=self::RES?>/img/icon/6.png" alt="">
        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-6">
                                <div class="single_add d-flex">
                                    <div class="icon">
                                        <img src="<?=self::RES?>/img/svg_icon/address.svg" alt="">
                                    </div>
                                    <div class="ifno">
                                        <h4>Address</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="single_add d-flex">
                                    <div class="icon">
                                        <img src="<?=self::RES?>/img/svg_icon/head.svg" alt="">
                                    </div>
                                    <div class="ifno">
                                        <h4>Reservation</h4>
                                        <p>+10 673 567 367</p>
